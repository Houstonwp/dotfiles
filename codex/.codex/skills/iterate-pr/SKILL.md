...
Look for bot comments from Codecov, Cursor, Bugbot, Seer, and other automated tools.
...
- If you need to update the PR description while iterating, use a temp file and `gh api -F body=@/tmp/pr-body.md` to preserve Markdown formatting
